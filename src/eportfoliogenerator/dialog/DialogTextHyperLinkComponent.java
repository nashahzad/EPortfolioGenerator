...
public class DialogTextHyperLinkComponent extends Stage
{
    ...
    public void createHyperlinks(TextComponent textComponent, EPortfolioView ui){
        ...
        addRemoveVBox.getChildren().addAll(removeHyperlinkButton);
        ...
        paragraphTextArea = new TextArea(textComponent.getParagraphOrHeader());
        paragraphTextArea.setOnContextMenuRequested(event1 -> {
            IndexRange indexRange = paragraphTextArea.getSelection();
            HyperLinkComponent hyperLinkComponent = new HyperLinkComponent();
            hyperLinkComponent.setStart(indexRange.getStart());
            hyperLinkComponent.setEnd(indexRange.getEnd());
...
//        addHyperlinkButton.setTooltip(new Tooltip("Add Hyperlink"));
        ...
        Image image = new Image("file:" + StartUpConstants.ICON_REMOVE_PAGE);
